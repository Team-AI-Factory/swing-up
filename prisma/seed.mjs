...
const defaultSources = [
  ...
  { source: "FMP Catalyst", status: process.env.FMP_API_KEY ? "degraded" : "not_configured", usage: "Financial Modeling Prep live catalyst ear", notes: process.env.FMP_API_KEY ? "FMP_API_KEY is configured; run a tiny source check to mark connected/degraded/failed." : "FMP_API_KEY is not configured; optional for first alert." },
  ...
  { source: "FRED Macro", status: "degraded", usage: "Required macro data ear", notes: "Canonical FRED macro source uses public fredgraph CSV mode without an API key." },
