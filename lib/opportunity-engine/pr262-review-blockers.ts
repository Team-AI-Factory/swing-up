export type Pr262ReviewBlocker = "missing_profile" | "committee_disabled" | "same_evidence" | "ai_budget" | "review_capacity"
...
export function pr262QueueBlocker(error: string | null | undefined): Pr262ReviewBlocker | null {
  ...
  const explicit = value.match(/:blocker=(committee_disabled|same_evidence|ai_budget|review_capacity|ai_provider|accounting_unavailable|reservation_unclassified)(?=[:;\s]|$)/)?.[1];
