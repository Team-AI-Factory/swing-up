...
new Function("require", "module", "exports", output)((name) => { if (name === "@/lib/ai-committee/review-policy") return loadTsModule(name); throw new Error("Unexpected runtime import"); }, cjsModule, cjsModule.exports);
