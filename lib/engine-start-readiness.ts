...
export const SOURCE_DEFINITIONS: SourceDefinition[] = [
  ...
  { name: "Alpha Vantage", required: false, route: "app/api/ears/alpha-vantage/run/route.ts", adapter: "lib/ears/alpha-vantage.ts", apiKey: "ALPHA_VANTAGE_API_KEY", notes: "Optional backup market/fundamentals ear." },
